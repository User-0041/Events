		...
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					...
					<li>
						<a href="event-list.php" class="ttr-material-button">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" action={{ route('Events.store') }} method="POST" enctype="multipart/form-data">
                                @csrf
								<div class="row">
									<div class="col-12">
										<div class="ml-auto">
									...
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" name="ev_name" type="text" value="">
                                            @error('ev_name')
									...
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" name="ev_date" type="date" value="">
									...
									<div class="form-group col-12">
										...
										<div>
											<textarea class="form-control" name="ev_describ"> </textarea>
                                            @error('ev_describ')
											<small class="text-danger"><{{ $message }}></small>
                                            @enderror
										</div>
										...
										<table id="item-add" style="width:100%;">
											<tr class="list-item">
												<td>
													<div class="row">
														<div class="col-md-4">
															<label class="col-form-label">Event picture</label>
															<div>
																<input class="" name="ev_pic" type="file" value="">
									...
									<div class="col-12">
										<button type="submit" class="btn-secondry"><i class="fa fa-fw fa-plus-circle"></i>Add </button>
										<button type="reset" class="btn" style="background-color:red; color:white;">cancel</button>
									</div>
								</div>
							</form>
						</div>
